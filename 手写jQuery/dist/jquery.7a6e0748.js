...
window.jQuery = function (selectorOrArray) {
  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        var e = Array.from(elements[i].querySelectorAll(selector));
    ...
    children: function children() {
      var array = [];
      this.each(function (node) {
        array.push.apply(array, _toConsumableArray(node.children)); //展开操作符 将node.children数组拆开
      });
      return jQuery(array);
    },
...
},{}]},{},["C:/Users/24289/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","jquery.js"], null)
